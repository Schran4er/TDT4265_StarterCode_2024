...
def train():
    ...
    input_yaml = "/cluster/work/felixzr/TDT4265_StarterCode_2024/project/model1_auto3dseg_wImageCAS_pretrain/model1_auto3dseg_input.yaml"
    ...
    input_config = {
        ...
        "datalist": "/cluster/work/felixzr/TDT4265_StarterCode_2024/project/model1_auto3dseg/data_ImageCAS.json",  # required
        "dataroot": "/cluster/work/felixzr/TDT4265_StarterCode_2024/data_flat_ImageCAS",  # required
    }
    ...
    work_dir = "/cluster/work/felixzr/TDT4265_StarterCode_2024/project/model1_auto3dseg_wImageCAS_pretrain"
